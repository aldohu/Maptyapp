...
class App {
	...
	_newWorkout(e) {
		...
		//if is cycling create cycling obj

		// add obj to workout arr
...
const run1 = new Running([37, -11], 5.2, 24, 178);
const cycling1 = new Cycling([37, -11], 27, 95, 523);
